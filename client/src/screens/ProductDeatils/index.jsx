...
const ProductDetails = () => {
  ...
  return (
    <div className="bg-white pb-10 pt-6 sm:pb-24">
          ...
          <div className="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
            ...
            <div className="lg:col-span-5 lg:col-start-8">
              ...
              <button
                ...
                className="focus:outline-none focus:ring-2 mt-8 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-semibold cursor-pointer text-white transition-all hover:bg-indigo-700"
              >
                Add to Cart
              </button>
              ...
              <div className="mt-10 border-t border-gray-200 pt-8">
                ...
                <div className="mt-4 prose prose-sm text-slate-500">
